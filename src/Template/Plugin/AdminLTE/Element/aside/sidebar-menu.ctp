...
<ul class="sidebar-menu">
    ...
    <li>
        <a href="<?php echo $this->Url->build('/monitor'); ?>">
            <i class="fa fa-user-md"></i> <span>Monitor</span>
        </a>
    </li>
    <li>
        <a href="<?php echo $this->Url->build('/ingresos'); ?>">
            <i class="fa fa-money"></i> <span>Ingresos</span>
        </a>
    </li>
    <li>
        <a href="<?php echo $this->Url->build('/gastos'); ?>">
    ...
    <li>
        <a href="<?php echo $this->Url->build('/fichas'); ?>">
            <i class="fa fa-folder-open"></i> <span>Fichas Clinicas</span>
        </a>
    </li>
    <li>
